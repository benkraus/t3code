...
const ThreadProviderSlashCommandRunCommand = Schema.Struct({
  type: Schema.Literal("thread.provider-slash-command.run"),
  commandId: CommandId,
  threadId: ThreadId,
  command: TrimmedNonEmptyString,
...
const DispatchableClientOrchestrationCommand = Schema.Union([
  ...
  ThreadProviderSlashCommandRunCommand,
...
export const ThreadProviderSlashCommandRequestedPayload = Schema.Struct({
  threadId: ThreadId,
  command: TrimmedNonEmptyString,
  arguments: Schema.optional(Schema.String),
  modelSelection: Schema.optional(ModelSelection),
...
export const OrchestrationEvent = Schema.Union([
  ...
  Schema.Struct({
    ...EventBaseFields,
    type: Schema.Literal("thread.provider-slash-command-requested"),
    payload: ThreadProviderSlashCommandRequestedPayload,
  }),
  Schema.Struct({
    ...EventBaseFields,
