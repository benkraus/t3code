            ...
            status={
              <>
                ...
                <span className="mt-1 block">
                  Accepts `ws://`, `wss://`, `http://`, or `https://`. Include `?token=...` if the
                  server requires a WebSocket auth token.
                </span>
                {desktopConnectionError ? (
                  <span className="mt-1 block text-destructive">{desktopConnectionError}</span>
                ) : null}
              </>
            }
            control={
            ...
            <div className="mt-3 space-y-3 border-t border-border/60 pt-3">
              <label htmlFor="desktop-remote-host-url" className="block">
                ...
                <span className="mt-1 block text-xs text-muted-foreground">
                  The desktop app uses this WebSocket endpoint for chat, git, terminal, and project
                  APIs when remote mode is active.
                </span>
              </label>
              ...
              <div className="rounded-xl border border-border/60 bg-background/60 p-3">
                <div className="flex flex-wrap items-center gap-2">
                  <div className="min-w-0 flex-1">
                    <div className="text-xs font-medium text-foreground">Tailscale discovery</div>
                    ...
                    {discoveredTailscaleHosts.map((host) => (
                      ...
                      >
                        <div className="min-w-0">
                          <div className="text-xs font-medium text-foreground">{host.name}</div>
