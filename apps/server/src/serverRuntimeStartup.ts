...
import * as HerdrProjectionSync from "./herdr/HerdrProjectionSync.ts";
import {
...
export const make = Effect.gen(function* () {
  ...
  const herdrProjectionSync = yield* HerdrProjectionSync.HerdrProjectionSync;
  ...
  const startup = Effect.gen(function* () {
    ...
    yield* runStartupPhase(
      ...
      Effect.gen(function* () {
        ...
        yield* herdrProjectionSync.start.pipe(Scope.provide(reactorScope));
      }),
    );
